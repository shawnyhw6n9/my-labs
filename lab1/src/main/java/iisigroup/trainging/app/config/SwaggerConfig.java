 ...
 */
package iisigroup.trainging.app.config;
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        ApiInfo apiInfo = new ApiInfoBuilder().title("iisigroup.trainging.app.CAP").description("Cap by Spring Boot Application").version(apiVersion).build();
        return apiInfo;
    }
}
